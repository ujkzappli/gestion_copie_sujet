...
<div class="container-fluid py-4">
    ...
    <div class="row g-3 mb-4">
        <div class="col-xl-3 col-md-6">
            <div class="stats-card" style="border-color: #11998e;">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="text-muted mb-1 small">TOTAL COPIES</p>
                        <h3 class="mb-0 fw-bold" style="color: #11998e;">{{ number_format($stats['total_copies'] ?? 0) }}</h3>
                        <small class="text-muted">{{ $stats['total'] ?? 0 }} lots</small>
                    </div>
                    <div class="bg-success bg-opacity-10 rounded-circle p-3">
                        <i class="bi bi-file-earmark-text-fill text-success fs-2"></i>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="filter-card mb-4">
        ...
        <form id="filter-form" method="GET" action="{{ route('dashboard.cs') }}">
            <div class="row g-3">
                
                {{-- Département --}}
                <div class="col-lg-4 col-md-6">
                    <label class="form-label fw-semibold small">
                        <i class="bi bi-diagram-3 me-1 text-success"></i>Département
                    </label>
                ...
                <div class="col-lg-4 col-md-6">
                    <label class="form-label fw-semibold small">
                        <i class="bi bi-person-search me-1 text-success"></i>Enseignant
                    </label>
                ...
                <div class="col-lg-2 col-md-6">
                    <label class="form-label fw-semibold small">
                        <i class="bi bi-filter me-1 text-success"></i>Statut
                    </label>
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('dashboard.cs') }}" class="btn btn-outline-secondary">
